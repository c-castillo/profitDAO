...
var flatten = function flatten(chunks, executionContext) {
  return chunks.reduce(function(ruleSet, chunk) {
    ...
    if (Array.isArray(chunk))
      return [].concat(
        toConsumableArray(ruleSet),
        toConsumableArray(flatten(chunk, executionContext))
      );
...
var supportLevel = (function() {
  ...
  if (
    /^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test(process$1.env.TERM)
  ) {
    return 1;
  }
...
var Declaration = (function(_Node) {
  ...
  function Declaration(defaults$$1) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Declaration.__proto__ || Object.getPrototypeOf(Declaration)).call(
        this,
        defaults$$1
      )
    );
...
var Comment = (function(_Node) {
  ...
  function Comment(defaults$$1) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Comment.__proto__ || Object.getPrototypeOf(Comment)).call(
        this,
        defaults$$1
      )
    );
...
var AtRule = (function(_Container) {
  ...
  function AtRule(defaults$$1) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (AtRule.__proto__ || Object.getPrototypeOf(AtRule)).call(
        this,
        defaults$$1
      )
    );
  ...
  createClass(AtRule, [
    {
      ...
      value: function append() {
        ...
        return (_babelHelpers$get = get$1(
          AtRule.prototype.__proto__ || Object.getPrototypeOf(AtRule.prototype),
          "append",
          this
        )).call.apply(_babelHelpers$get, [this].concat(children));
      }
    },
    {
      key: "prepend",
      value: function prepend() {
        ...
        return (_babelHelpers$get2 = get$1(
          AtRule.prototype.__proto__ || Object.getPrototypeOf(AtRule.prototype),
          "prepend",
          this
        )).call.apply(_babelHelpers$get2, [this].concat(children));
      }
    },
    {
      key: "afterName",
...
var Rule = (function(_Container) {
  ...
  function Rule(defaults$$1) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Rule.__proto__ || Object.getPrototypeOf(Rule)).call(this, defaults$$1)
    );
...
var Root = (function(_Container) {
  ...
  function Root(defaults$$1) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Root.__proto__ || Object.getPrototypeOf(Root)).call(this, defaults$$1)
    );
  ...
  createClass(Root, [
    {
      ...
      value: function removeChild(child) {
        ...
        return get$1(
          Root.prototype.__proto__ || Object.getPrototypeOf(Root.prototype),
          "removeChild",
          this
        ).call(this, child);
      }
...
var SafeParser = (function(_Parser) {
  ...
  function SafeParser() {
    ...
    return possibleConstructorReturn(
      this,
      (SafeParser.__proto__ || Object.getPrototypeOf(SafeParser)).apply(
        this,
        arguments
      )
    );
      ...
      value: function rules() {
        ...
        this.tags.forEach(function(tag) {
          return arr.splice.apply(
            arr,
            [arr.length, 0].concat(
              toConsumableArray(Array.from(sheetForTag(tag).cssRules))
            )
          );
        });
        return arr;
...
var injectGlobal = function injectGlobal(strings) {
  ...
  var globalStyle = new ComponentStyle(
...
var ThemeProvider = (function(_Component) {
  ...
  function ThemeProvider() {
    ...
    var _this = possibleConstructorReturn(
      this,
      (ThemeProvider.__proto__ || Object.getPrototypeOf(ThemeProvider)).call(
        this
      )
    );
    ...
    },
    {
      ...
      value: function getChildContext() {
        return _extends(
          {},
          this.context,
          defineProperty({}, CHANNEL, this.broadcast.subscribe)
        );
      }
    },
    {
...
ThemeProvider.childContextTypes = defineProperty(
  {},
  CHANNEL,
  index$7.func.isRequired
);
...
var AbstractStyledComponent = (function(_Component) {
  ...
  function AbstractStyledComponent() {
    ...
    return possibleConstructorReturn(
      this,
      (
        AbstractStyledComponent.__proto__ ||
        Object.getPrototypeOf(AbstractStyledComponent)
...
AbstractStyledComponent.contextTypes = defineProperty(
  {},
  CHANNEL,
  index$7.func
);
...
var _styledComponent = function(ComponentStyle) {
  ...
  var createStyledComponent = function createStyledComponent(
      ...
      function StyledComponent() {
        ...
        return (
          (_ret = ((_temp = ((_this = possibleConstructorReturn(
            this,
            (_ref =
              StyledComponent.__proto__ ||
              Object.getPrototypeOf(StyledComponent)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
      ...
      createClass(StyledComponent, [
        ...
        },
        {
          ...
          value: function render() {
            ...
            propsForElement.className = [className, generatedClassName]
              .filter(function(x) {
                return x;
              })
              .join(" ");
    ...
    StyledComponent.displayName = isTag(target)
      ? "styled." + target
      : "Styled(" + (target.displayName || target.name || "Component") + ")";
...
var autoprefix = function(root) {
  root.walkDecls(function(decl) {
    ...
    var objStyle = defineProperty(
      {},
      camelizeStyleName_1(decl.prop),
      decl.value
    );
    var prefixed = _static(objStyle);
    Object.keys(prefixed)
      .reverse()
...
var withTheme = function(Component$$1) {
  ...
  return (
        ...
        },
        {
          ...
          value: function render() {
            ...
            return React.createElement(
              Component$$1,
              _extends({ theme: theme }, this.props)
            );
          }
        }
      ]);
    ...
    (_class.contextTypes = defineProperty({}, CHANNEL, index$7.func)),
    _temp2
  );
};
