...
const CERTIFICATECLAIM = "revenueDAO Demo";
          ...
          <CredsTable>
            <tbody>
              <tr>
                ...
                <td>
                  <CredsButton onClick={this.credentialsbtnClickA}>
                    Get
                  </CredsButton>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <CredsButton onClick={this.credentialsbtnClickB}>
                    Get
                  </CredsButton>
                </td>
              </tr>
              <tr>
                <td>
                  <CredsLabel>Certificate: revenueDAO Demo</CredsLabel>
                </td>
                <td>
                  <CredsButton onClick={this.credentialsbtnClickC}>
                    Get
                  </CredsButton>
                </td>
              </tr>
